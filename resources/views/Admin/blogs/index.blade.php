            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/admin/blogs') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                            ...
                            <table class="table">
                                ...
                                @foreach($blogs as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/blogs/' . $item->id) }}" title="View blog"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/blogs/' . $item->id . '/edit') }}" title="Edit blog"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
